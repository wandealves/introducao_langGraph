...
Este projeto avaliador de redação baseado em [LangGraph](https://github.com/langchain-ai/langgraph) e [Langchain-LiteLLM](https://docs.litellm.ai/docs/), utilizando o gerenciador de pacotes [uv](https://docs.astral.sh/uv/reference/cli/) para dependências.
